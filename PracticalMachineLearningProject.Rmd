...
# Fit the model using all 53 predictors with a Random Forest method
modelFit <- train(classe ~ ., data=training3, method="rf", prox=TRUE)
...
selectedTree <- getTree(modelFit$finalModel, k=28)

```

The OOB error rate is 1.02%.
